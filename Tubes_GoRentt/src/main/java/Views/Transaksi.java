...
public class Transaksi extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(getColumnData(1));
    ...
    private ComboBoxModel<String> getColumnData(int columnIndex) {
        int rowCount = sd.tabeltersedia.getRowCount();
        String[] columnData = new String[rowCount];

        for (int i = 0; i < rowCount; i++) {
            columnData[i] = sd.tabeltersedia.getValueAt(i, columnIndex).toString();
        }
