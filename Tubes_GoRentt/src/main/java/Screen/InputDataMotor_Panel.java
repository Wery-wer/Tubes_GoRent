 ...
 * @author USER
 */
public class InputDataMotor_Panel extends javax.swing.JFrame {

    /**
     * Creates new form InputDataMotor_Panel
     */
    public InputDataMotor_Panel() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InputDataMotor_Panel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InputDataMotor_Panel().setVisible(true);
            }
        });
    }
